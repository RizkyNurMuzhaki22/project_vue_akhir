...
<section class="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px] text-white bg-blue-800">
    ...
    <div class="-mx-4 flex flex-wrap lg:justify-between">
      <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div class="mb-12 max-w-[570px] lg:mb-0">
          ...
          <p class="text-body-color mb-9 text-base leading-relaxed">
            "Jika ada saran,masukan atau keluhan silahkan tanyakan saja pada kami jangan sungkan-sungkan yaa !"
          </p>
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              ...
              <p class="text-body-color text-base">
                Kosambi,Kota Bandung, West java. Indonesia
              </p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              ...
              <p class="text-body-color text-base">(+62)895-2020-8066</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div class="w-full">
              ...
              <p class="text-body-color text-base">rizki.nurmuzhaki@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
      <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
        <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
          <form>
            <div class="mb-6">
              <label for=""><p class="text-base text-gray-900 dark:text-white">Name :</p></label>
              <input
                type="text"
            ...
            <div class="mb-6">
              <label for=""><p class="text-base text-gray-900 dark:text-white">Email :</p></label>
              <input
                type="email"
            ...
            <div class="mb-6">
              <label for=""><p class="text-base text-gray-900 dark:text-white">Phone Number :</p></label>
              <input
                type="text"
            ...
            <div class="mb-6">
              <label for=""><p class="text-base text-gray-900 dark:text-white">Message :</p></label>
              <textarea
                rows="6"
